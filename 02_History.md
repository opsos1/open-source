...
- ### 오픈소스(자유 소프트웨어) 운동의 시작
  ...
  - 소프트웨어 저작권과 돈 때문에 분쟁에 시달리는 것을 본 리차드 스탈만은 이 현상을 지극히 잘못된 일이라고 주장했습니다.

<br>

## **GNU (1983)**
### **"모두가 공유할 수 있는 소프트웨어"** 를 목표로 한 프로젝트입니다.
  - 1983년 MIT 프로그래머인 **리차드 스탈만**에 의해 [GNU 프로젝트](https://www.gnu.org)가 시작되었습니다.
...
자유 소프트웨어 운동의 개척자인 리차드 스탈만도 이 단어를 쓰기로 결정했습니다.
...
비트 키퍼를 개발한 BitMover 회사가 2005년에 특정 커널 개발자에게 부여한 무료 라이센스를 취소했습니다.

비트 키퍼 라이센스가 없어진 후 리누스 토발즈는 그 만의 DVCS를 만들기로 했습니다.(Git)<br>
